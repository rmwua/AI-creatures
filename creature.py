...
class Creature:
    ...
    def get_flat_links(self):
        ...
        flat_links = genome.Genome.genome_to_links(gdicts)
        self.flat_links = flat_links
        return self.flat_links
    ...
    def get_motors(self):
        ...
        if self.motors is None:
            ...
            for i in range(1, len(self.exp_links)):
                l = self.exp_links[i]
                # here we assume that your URDFLink
                # class has control_waveform,
                # control_amp and control_freq
                # properties, read from the genome
                m = Motor(l.control_waveform,
                          l.control_amp,
                          l.control_freq)
                motors.append(m)
            self.motors = motors
